        ...
        <table className="table-auto w-full mt-4">
          <thead>
            <tr className="border-b border-t">
              <td className="p-2 font-bold border-2 border-gray-400 p-2 font-bold">
                STT
              </td>
              <td className="p-2 font-bold border-2 border-gray-400 p-2 font-bold">
                Tựa đề
          ...
          <tbody>
            {posts?.rows?.map((item, index) => (
              <tr key={item.id}>
                <td
                  className={`p-2 p-2 border-2 border-gray-400 ${
                ...
                >
                  <span
                    className="p-2 font-medium cursor-pointer text-blue-500 hover:underline"
                    onClick={() => setEdit(item)}
                  >
                    Sửa
                  </span>
                  <span
                    className="p-2 font-medium cursor-pointer text-red-500 hover:underline"
                    onClick={() => {
                      Swal.fire({

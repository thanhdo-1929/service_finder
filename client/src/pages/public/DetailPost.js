...
import { SliderCustom, RelatedPost, QuestionAndAnswer, VoteAndComment, VoteOption, Map } from '../../components'
...
const { HiLocationMarker, TbReportMoney, RiCrop2Line, BsStopwatch, MdMail, SiZalo } = icons
const DetailPost = () => {
    const { pid } = useParams()
        ...
        <div className='w-full flex gap-4 relative'>
            ...
            <div className='w-[30%] flex-auto flex flex-col gap-8'>
                <div className='w-full bg-yellow-500 rounded-md flex flex-col items-center p-4 gap-4'>
                    ...
                    <small className='flex items-center gap-1'><MdMail />{post?.user?.email}</small>
                    <a

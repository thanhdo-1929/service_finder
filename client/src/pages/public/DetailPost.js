    ...
    <div className='w-full flex gap-4 relative'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div className='flex items-center justify-between'>
              {post?.price && (
                <span className='flex items-center gap-1'>
                  <TbReportMoney />
                  <span className='font-semibold text-lg text-green-600'>{`${Number(
                    post?.price.toFixed(1)
                  ).toLocaleString()} đồng/tháng`}</span>
                </span>
              )}
              {post?.area && (
                <span className='flex items-center gap-1'>
            ...
            <table className='w-full'>
              <tbody className='w-full'>
                <tr className='w-full'>
                  ...
                  <td className='p-2'>
                    {post?.receiverName || post?.user?.name}
                  </td>
                </tr>
                <tr className='w-full bg-gray-200'>
                  <td className='p-2'>Điện thoại</td>
                  <td className='p-2'>
                    {post?.receiverPhone || post?.user?.phone}
                  </td>
                </tr>
                <tr className='w-full'>
      ...
      <div className='w-[30%] flex-auto flex flex-col gap-8'>
        <div className='w-full bg-yellow-500 rounded-md flex flex-col items-center p-4 gap-4'>
          <img
            src={post?.user?.image || anonAvatar}
            alt='avatar'

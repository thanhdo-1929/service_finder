...
const Login = () => {
    ...
    return (
        <div className='w-full flex items-center relative justify-center'>
            {isForgot && <div onClick={() => setIsForgot(false)} className='fixed top-0 right-0 left-0 z-50 bottom-0 bg-overlay-70 flex items-center justify-center'>
                <div onClick={e => e.stopPropagation()} className='w-[600px] bg-white rounded-md p-4 flex flex-col gap-2'>
                    ...
                    <div className='w-full flex flex-col'>
                        ...
                        />
                        {invalidEmail && <small className='text-red-500 italic' >{invalidEmail}</small>}
                    </div>
            ...
            <div className='absolute top-0 left-0 right-0 bottom-0 z-10 flex items-center justify-center bg-gradient-to-br from-pink-500 to-purple-500'>
                <div className='bg-white w-[600px] p-[30px] rounded-md shadow-lg border'>
                    ...
                    <div className='mt-7 flex items-center justify-between'>
                        {isRegister
                            ...
                            : <>
                                <small onClick={() => setIsForgot(true)} className='text-[blue] hover:underline cursor-pointer' >Bạn quên mật khẩu</small>
                                <small
                                    onClick={() => {
                                        setIsRegister(true)
                                        setPayload({

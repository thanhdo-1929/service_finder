        ...
        <div className='bg-white rounded-md p-4 flex flex-col items-center w-full gap-3'>
            ...
            <div className='bg-blue-100 border-blue-200 border rounded-md p-4 text-sm text-blue-800 mt-4'>
                ...
                <div className='mt-4'>
                    ...
                    <span>Thành viên muốn đăng bài thì xin vui lòng liện hệ với Admin theo thông tin bên dưới. Chúc mọi người ngày mới làm việc hiệu quả.</span>
                </div>
            </div>
            <div className='flex flex-wrap gap-4 justify-between'>
                ...
                <span className='flex gap-2 w-[47%] flex-auto py-2 px-4 border items-center'>
                    ...
                    <a className='text-blue-500 hover:underline' href='tel:0359067259'>0359067259</a>
                </span>
                <span className='flex gap-2 w-[47%] flex-auto py-2 px-4 border items-center'>
                    <span className='font-medium'>Email:</span>
                    <a className='text-blue-500 hover:underline' href='mailto:dotuanthanhh@gmail.com'>dotuanthanhh@gmail.com</a>
                </span>
                <span className='flex gap-2 w-[47%] flex-auto py-2 px-4 border items-center'>
                    <span className='font-medium'>Zalo:</span>
                    <a className='text-blue-500 hover:underline' href='https://zalo.me/0359067259'>Đỗ Thành</a>
                </span>
            </div>
        </div>
    )
